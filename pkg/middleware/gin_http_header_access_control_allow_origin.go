...
// GinHTTPHeaderAccessControlConfigSetting sets configurations.
type GinHTTPHeaderAccessControlConfigSetting struct {
...
// GinHTTPHeaderAccessControl sets Access-Control-XXXXX header.
// https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS
func GinHTTPHeaderAccessControlAllow(
	cs *GinHTTPHeaderAccessControlConfigSetting,
) gin.HandlerFunc {
...
func DefaultConfig() *GinHTTPHeaderAccessControlConfigSetting {
	return &GinHTTPHeaderAccessControlConfigSetting{
...
func (cs *GinHTTPHeaderAccessControlConfigSetting) validateOrigin(origin string) bool {
	if cs.AllowAllOrigins {
		return true
	}
...
func (cs *GinHTTPHeaderAccessControlConfigSetting) validateMethodOptions() bool {
