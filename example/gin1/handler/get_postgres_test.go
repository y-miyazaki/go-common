...
func TestHTTPHandler_HandlePostgres(t *testing.T) {
	// Skip test that requires real PostgreSQL connection
	t.Skip("Skipping PostgreSQL test - requires real PostgreSQL database connection")

	// This test would require setting up mock PostgreSQL database
